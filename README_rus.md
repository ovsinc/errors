...
| `func (e *Error) WriteTranslateMsg(w io.Writer)` | Запишет перевод сообщения ошибки в буфер. В случае неудачи перевода в буфер запишется оригинальное сообщение (без перевода). |
